...
public class CartServlet extends HttpServlet
{
	public void service(HttpServletRequest req,HttpServletResponse res) throws ServletException,IOException
	{
		...
		if(session!=null)
		{
			...
			out.println("<table bgcolor='lightblue' border=1 width=400>");
			if(mobiles!=null)
			{
			out.println("<tr>");
			...
			out.println("</table>");
			out.println("<br><br><a href='netbank.html'><input type='submit' value='Buy Now' /><input type='submit' value='Back' /></a>");
		}
		else
		{
